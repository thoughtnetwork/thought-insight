...
describe('Blocks', function() {
  describe('/blocks/:blockHash route', function() {
    ...
    var dashcoreBlock = dashcore.Block.fromBuffer(new Buffer(blocks['000000000000c53bf17a98b9ee042d6d4c3faf37d7a9f5c1335cce6df896f2f4'], 'hex'));

    var node = {
      log: sinon.stub(),
      getBlock: sinon.stub().callsArgWith(1, null, dashcoreBlock),
      services: {
        dashd: {
    ...
    it('block pool info should be correct', function(done) {
      var block = dashcore.Block.fromString(blocks['000000000000000004a118407a4e3556ae2d5e882017e7ce526659d8073f13a4']);
      var node = {
        log: sinon.stub(),
  ...
  it('reward for block 100000 should be correct', function(done) {
    ...
    var dashcoreBlock = dashcore.Block.fromBuffer(new Buffer(blockHex, 'hex'));
