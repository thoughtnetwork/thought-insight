  ...
  <div class="container">
    <div id="home" class="row">
      <div class="col-xs-12 col-md-8">
        ...
        <table class="table table-hover table-striped" style="table-layout: fixed;">
          ...
          <tr class="fader" data-ng-repeat='tx in txs'>
            ...
            <td class="text-right"><span class="ellipsis">{{$root.currency.getConvertion(tx.valueOut) || tx.valueOut + ' THT'}}</span></td>
          </tr>
          </tbody>
        </table>
      ...
      <div class="col-xs-12 col-md-4 col-gray">
        ...
        <p translate><strong>insight</strong>  is an <a href="https://github.com/thoughtnetwork/"
          target="_blank">open-source Thought Network blockchain explorer</a> with complete REST and websocket APIs that can be used for writing web wallets and other apps  that need more advanced blockchain queries than provided by thoughtd RPC.  Check out the <a href="https://github.com/thoughtnetwork/" target="_blank">source code</a>.</p>
        <p translate><strong>insight</strong> is still in development, so be sure to report any bugs and provide feedback for improvement at our <a href="https://github.com/thoughtnetwork/" target="_blank">github issue tracker</a>.</p>
