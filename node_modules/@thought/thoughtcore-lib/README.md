...
[![NPM Package](https://img.shields.io/npm/v/@thought/thoughtcore-lib.svg)](https://www.npmjs.org/package/@thought/thoughtcore-lib)
...
```
npm install @thought/thoughtcore-lib
```
